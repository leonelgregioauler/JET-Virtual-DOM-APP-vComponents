...
import componentStrings = require("ojL10n!./resources/nls/component-vdom-strings");
import "css!./component-vdom-styles.css";
import "ojs/ojavatar";
...
function ComponentVdomImpl({
  ...
  const formatPhoneNumber = (number: number) => {
    return number.toString().replace(/(\d{2})(\d{5})(\d{4})/, "$1-$2-$3");
  };
    ...
    <div
      ...
      <div class="oraclejet-demo-card-back-side">
        <div class="oraclejet-demo-card-inner-back-side">
          ...
          {workNumber && (
            <>
              <h5 class="oj-typography-heading-xs">Telefone</h5>
...
export const ComponentVdom: ComponentType<
  ExtendGlobalProps<ComponentProps<typeof ComponentVdomImpl>>
